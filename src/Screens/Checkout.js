    ...
    <SafeAreaView style={{flex: 1}}>
      <View style={{flex: 1, backgroundColor:'lightblue'}}>
        ...
        <View
          ...
          <Text style={{color:'brown'}}>{'रु ' + getTotal()}</Text>
        </View>
        <View>
          <FlatList
            data={addressList}
        ...
        <Text style={{margin: 20, fontSize: 18, color:'brown'}}>Select Address</Text>
        <Text style={{marginLeft: 20, fontSize: 16, color:'brown'}}>
          {selectedAddress == ''
